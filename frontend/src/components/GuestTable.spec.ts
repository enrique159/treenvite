...
const guest: Guest = {
  id: 'guest-1', eventId: 'event-1', parentId: null, name: 'Ana Torres', email: 'ana@example.com', phone: null,
  groupName: 'Familia', relationLabel: 'Anfitriona', rsvp: 'confirmed', companions: 1, dietary: null, notes: null, version: 1,
}
